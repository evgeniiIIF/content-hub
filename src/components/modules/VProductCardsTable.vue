  ...
  <div class="table">
    <div class="container">
      ...
      <div class="table__body js-dropdown-menu--root">
        <VRecursiveList :items="productCardsItems">
          <template #slot1="{ itemL1, itemNomenclatureL1 = itemL1, indexL1, itemNomenclatureIndexL1 = indexL1 }">
            <div class="item-nomenclature row-table">
              ...
              <div class="item-nomenclature__name">-</div>
              <div class="item-nomenclature__warehouse">-</div>
              <div class="item-nomenclature__price">{{ itemNomenclatureL1.price }}</div>
              <div class="item-nomenclature__category">{{ itemNomenclatureL1.category.name }}</div>
              <div class="item-nomenclature__status">-</div>
              <!-- <div
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        headCategories: ['Бренд', 'Артикул', 'Наименование', 'Склад', 'Цена, ₽', 'Категория', 'Статус'],
    ...
    computed: {
      ...mapGetters('productCardsItems', {
        productCardsItems: 'items',
      }),
    },

    methods: {
      ...mapActions('productCardsItems', ['GET_ITEMS_PRODUCT_CARDS']),
    ...
    async mounted() {
      await this.GET_ITEMS_PRODUCT_CARDS();
