...
export default {
  ...
  actions: {
    async SEND_MARKET_DATA_FOR_UPDATE(store, data) {
      const url = `http://api.hub.absit.ru/api/v1/markets/${data.marketId}/update`;

      const dataFor = data.dataForUpdateMarket;
